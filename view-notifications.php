						...
						<div class="col-lg-12 clear-padding-xs">
							<div class="col-sm-12 col-md-8">
								<div class="my-msg dash-item">
									<h6 class="item-title"><i class="fa fa-board"></i>NOTIFICATION DETAIL</h6>
									<div class="inner-item">
										<div class="profile-intro">
											<div class=" col-sm-12 col-md-5  clear-padding">
												<img src="<?php echo $notif['photourl'] ?>"  alt="NO IMAGE AVAILABE" />
											</div>
											<div class="col-sm-12 col-md-6">
													<div class="profile-details">
														...
														<div class="detail-row">
															...
															<div class="col-md-12 col-sm-12 col-xs-12 clear-padding">
																<span>DATE</span>
																<p><?php echo date("h:i a,d-M-Y", substr($notif['date'], 0, 10)); ?></p>
															</div>
														</div>
                                                        <div class="clearfix"></div>
                                                        <div class="detail-row">
															<div class="col-md-12 col-sm-12 col-xs-12 clear-padding" style="word-wrap:break-word">
																<span>CONTENT</span> 
																<p><?php echo $notif['content'] ?></p>
															</div>
														</div>
