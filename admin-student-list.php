    ...
    <body>
		...
		<div class="parent-wrapper" id="outer-wrapper">
				...
				<ul class="sidebar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li>
								<a href="#"><i class="fa fa-caret-right"></i>ALL STUDENT  </a>
							</li>
						</ul>
						<div class="clearfix"></div>
					</li>
			...
			<div class="main-content" id="content-wrapper">
										...
										<table id="attendenceDetailedTable" class="display responsive nowrap" cellspacing="0" width="100%">
											<thead>
												<tr>
													...
													<th><i class="fa fa-puzzle-piece"></i>PARENT NAME</th>
													<th><i class="fa fa-envelope-o"></i>PARENT EMAIL</th>
											...
											<tbody>
												...
												<tr>
													...
													<td id='parentname<?php echo $r['id'] ?>'><?php echo $r['parentname'] ?></td>
													<td id='pemail<?php echo $r['id'] ?>'><?php echo $r['parentemail'] ?></td>
													<input type="hidden" value="<?php echo $r['pwd'] ?>" id="pwd<?php echo $r['id'] ?>">
												<input type="hidden" value="<?php echo $r['parent_pwd'] ?>" id="ppwd<?php echo $r['id'] ?>" >
				...
				<input type="hidden"  id="deletemodalid" name="userid">
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body dash-form">
								...
								<div class="col-sm-3">
									<label class="clear-top-margin"><i class="fa fa-user"></i>PASSWORD</label>
									<input type="text" name="pwd" id="editpwd"  />
								</div>
								<div class="col-sm-3">
									<label class="clear-top-margin"><i class="fa fa-book"></i>CLASS</label>
									<input type="text" name="cla" id="editclass"  />
								</div>
								<div class="clearfix"></div>
								<div class="col-sm-3">
									<label><i class="fa fa-cogs"></i>BATCH</label>
									<input type="text" name="batch" id="editbatch" />
								</div>
								<div class="col-sm-3">
									<label><i class="fa fa-puzzle-piece"></i>PARENT NAME</label>
									<input type="text" name="parentname" id="editparent" />
								</div>
								<div class="col-sm-3">
									<label><i class="fa fa-envelope-o"></i>PARENT EMAIL</label>
									<input type="text" name="parentemail" id="editparentemail" />
								</div>
								
								<div class="col-sm-3">
									<label><i class="fa fa-envelope-o"></i>PARENT PASSWORD</label>
									<input type="text" name="parent_pwd" id="editparentpwd"  />
								</div>
								<div class="clearfix"></div>
							</div>
		...
		<script type="text/javascript">
			function passdata(id){
				...
				document.getElementById("editid").value= document.getElementById("id"+id).innerText;
			    document.getElementById("editname").value=document.getElementById("name"+id).innerText;
				document.getElementById("editclass").value=document.getElementById("class"+id).innerText;
				document.getElementById("editbatch").value=document.getElementById("batch"+id).innerText;
				document.getElementById("editparent").value=document.getElementById("parentname"+id).innerText;
				document.getElementById("editparentemail").value=document.getElementById("pemail"+id).innerText;
				document.getElementById("editparentpwd").value=document.getElementById("ppwd"+id).value;
				document.getElementById("editpwd").value=document.getElementById("pwd"+id).value;
