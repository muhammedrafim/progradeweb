				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<h5 class="page-title"><i class="fa fa-book"></i>ADD BOOOKS</h5>
						...
						<div class="col-lg-12 clear-padding-xs">
							<div class="col-md-12">
								<div class="dash-item first-dash-item">
									<h6 class="item-title"><i class="fa fa-book"></i>BOOK INFO</h6>
									<div class="inner-item">
										<form action="admin-insert-book.php" method="post" enctype="multipart/form-data">
										<div class="dash-form">
											<div class="col-sm-3">
												<label class="clear-top-margin"><i class="fa fa-book"></i>NAME</label>
												<input type="text" name="name" placeholder="PHYSICS" />
											</div>
											<div class="col-sm-3">
												<label class="clear-top-margin"><i class="fa fa-id"></i>ID</label>
												<input type="text" name="id" placeholder="000" />
											</div>
											<div class="col-sm-3">
												<label class="clear-top-margin"><i class="fa fa-user"></i>AUTHOR</label>
												<input type="text"name="author" placeholder="LKG" />
											</div>
											<div class="col-sm-3">
												<label class="clear-top-margin"><i class="fa fa-cogs"></i>CATEGORY</label>
