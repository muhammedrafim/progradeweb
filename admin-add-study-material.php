				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12 clear-padding-xs">
							<h5 class="page-title"><i class="fa fa-book"></i>ALL STUDY MATERIALS</h5>
						...
						<div class="col-lg-12 clear-padding-xs">
							<div class="col-sm-4">
								<div class="dash-item first-dash-item">
									<h6 class="item-title"><i class="fa fa-plus-circle"></i>ADD STUDY MATERIAL</h6>
									<div class="inner-item">
									<form action="admin_insert_materials.php" method="post" enctype="multipart/form-data"> 
										<div class="dash-form">
											<label class="clear-top-margin"><i class="fa fa-cogs"></i>NAME</label>
											<input type="text" name="name" placeholder="title">
											<label><i class="fa fa-info-circle"></i>FOR CLASS</label>
											<textarea placeholder="Enter the class" name="class"></textarea>
                                            
											<label><i class="fa fa-info-circle"></i>FOR BATCH</label>
											<textarea placeholder="Enter batch" name="batch"></textarea>
											<label><i class="fa fa-photo"></i>FILE</label>
							...
							<div class="col-sm-8">
								<div class="dash-item first-dash-item">
									<h6 class="item-title"><i class="fa fa-book"></i>ALL STUDY MATERIALS</h6>
									<div class="inner-item">
										<table id="attendenceDetailedTable" class="display responsive nowrap" cellspacing="0" width="100%">
											<thead>
												<tr>
													<th><i class="fa fa-user"></i>NAME</th>
													<th><i class="fa fa-user-secret"></i>ADDED BY</th>
													<th><i class="fa fa-cogs"></i>DATE</th>
													<th><i class="fa fa-plus"></i>FOR</th>
													<th><i class="fa fa-sliders"></i>ACTION</th>
												</tr>
											</thead>
											<tbody>
											<?php 												
												$qu = "SELECT * FROM study_material ";
											...
											{  ?>
												...
												<tr>
													...
													<td>Class: <?php echo $val['class'] ?>- Batch :<?php echo $val['batch'] ?></td>
				...
				<div id="deleteDetailModal" class="modal fade" role="dialog">
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<form method='post' action='admin-delete-materials.php'>
